...
const Footer = () => {
  ...
  const trendingCategories = [
    ...
    "Indian Prom Dresses",
    "Plus Size Lehengas",
    "Plus Size Panjabi Patiala Suits",
    "Plus Size Sharara Suits",
    "Plus Size Indian Trouser Suits",
    "Plus Size Churidar Dresses",
    "Plus Size Men's Dresses",
    "Plus Size Kurtis",
    "Bollywood Sarees",
    "Bollywood Dresses",
    "Anarkali Suits",
    "Bollywood Patiala Suits",
    "Bollywood Lehengas",
    "Sherwanis",
    "Dhoti Kurtas",
    "Girls Wear",
  ...
  return (
    <Box sx={{ bgcolor: "#FAFAFA", pt: 5, pb: 3 }}>
            ...
            {trendingCategories.map((category, idx) => (
              <Link
                ...
                sx={{
                  ...
                  "&:hover": { color: "#E7356F" },
                  "&:after":
                    idx !== trendingCategories.length - 1
                      ? { content: '"|"', ml: 1.5, color: "#ddd" }
                      : {},
                }}
                style={{ fontFamily: "'Work Sans', sans-serif" }}
              >
            ...
            {weddingCollection.map((item, idx) => (
              <Link
                ...
                sx={{
                  ...
                  "&:hover": { color: "#E7356F" },
                  "&:after":
                    idx !== weddingCollection.length - 1
                      ? { content: '"|"', ml: 1.5, color: "#ddd" }
                      : {},
                }}
                style={{ fontFamily: "'Work Sans', sans-serif" }}
            ...
            {festiveCollection.map((item, idx) => (
              <Link
                ...
                sx={{
                  ...
                  "&:hover": { color: "#E7356F" },
                  "&:after":
                    idx !== festiveCollection.length - 1
                      ? { content: '"|"', ml: 1.5, color: "#ddd" }
                      : {},
                }}
                style={{ fontFamily: "'Work Sans', sans-serif" }}
            ...
            {fashionAccessories.map((item, idx) => (
              <Link
                ...
                sx={{
                  ...
                  "&:hover": { color: "#E7356F" },
                  "&:after":
                    idx !== fashionAccessories.length - 1
                      ? { content: '"|"', ml: 1.5, color: "#ddd" }
                      : {},
                }}
                style={{ fontFamily: "'Work Sans', sans-serif" }}
